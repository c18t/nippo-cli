# front-matter-parsing Specification

## Purpose

Define how nippo-cli parses and manages YAML front-matter in Markdown files,
enabling explicit metadata control for created/updated timestamps and
preserving user-defined fields.
